...
<div class="content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>编号：</td><td width='39%'>${shequmeishi.bianhao}</td><td  rowspan=5 align=center><a href=${shequmeishi.zhutu} target=_blank><img src=${shequmeishi.zhutu}  width=228 height=215 border=0></a></td></tr><tr>
         <td width='11%' height=44>菜名：</td><td width='39%'>${shequmeishi.caiming}</td></tr><tr>
         
         <td width='11%' height=44>菜系：</td><td width='39%'>${shequmeishi.caixi}</td></tr><tr>
         <td width='11%' height=44>特色：</td><td width='39%'>${shequmeishi.tese}</td></tr><tr>
         
         <td width='11%' height=44>用户名：</td><td width='39%'>${shequmeishi.yonghuming}</td></tr><tr>
         <td width='11%' height=100  >详情：</td><td width='39%' colspan=2 height=100 >${shequmeishi.yonghuming}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("shequmeishi",id)){
	pli=pli+1;
     %>
                                   <tr>
...
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('shequmeishi','<%=id%>')"/>
<input type=button name=Submit52 value=收藏 onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biao=shequmeishi&biaj=sqms&ziduan=caiming';" />
</td></tr>
