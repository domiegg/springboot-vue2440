...
function gows()
{
	document.location.href="dachulaila_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateDachulaila.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改大厨来啦<input type="hidden" name="id" value="${dachulaila.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${dachulaila.bianhao}';</script>	<script language="javascript">document.form1.caiming.value='${dachulaila.caiming}';</script>	<script language="javascript">document.form1.zhutu.value='${dachulaila.zhutu}';</script>	<script language="javascript">document.form1.caixi.value='${dachulaila.caixi}';</script>	<script language="javascript">document.form1.tese.value='${dachulaila.tese}';</script>	<script language="javascript">document.form1.xiangqing.value='${dachulaila.xiangqing}';</script>	<script language="javascript">document.form1.yonghuming.value='${dachulaila.yonghuming}';</script>	
					 </table>
			</form>
   </body>
</html>
